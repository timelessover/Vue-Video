<template>
  <div id="app">
    <div class="container">
      <div class="cl-video-container" @click="toggleContrlShow">
        <div class="iconfont icon-zanting" v-show="!state.playing" @click="play"></div>
        <video
        ...
        <transition name="fade">
          <div class="cl-contrl-content" v-show="state.contrlShow" @click.stop>
            <button class="cl-contrl-play-btn" @click="play">
              <svg
                class="cl-contrl-play-btn-icon"
            ...
            <!-- 进度条 -->
            <div class="cl-contrl-video-slider" @click="slideClick" @touchstart="videoMove">
              <div
                class="cl-contrl-video-inner"
                :style="{ 'transform': `translate3d(${video.pos.current}px, 0, 0)`}"
              ></div>
              <!-- 已经播放进度 -->
              <div class="cl-contrl-video-rail">
                <div class="cl-contrl-video-rail-inner" :style="{ width:`${video.pos.current}px`}"></div>
                <div class="cl-contrl-video-rail-inner-v" :style="{ width:`${video.loaded}%`}"></div>
              </div>
            </div>
            <div class="cl-contrl-video-time">
              <span class="cl-contrl-video-time-text">{{video.displayTime}}</span>
              <span class="cl-contrl-video-time-total">/{{video.totalTime}}</span>
            </div>
            <button class="cl-contrl-play-btn" @click="fullScreen">
              <svg
                class="cl-contrl-vol-btn-icon"
                viewBox="0 0 33 33"
                version="1.1"
                xmlns="http://www.w3.org/2000/svg"
...
.cl-contrl-video-time {
  padding: 0 10px;
  .cl-contrl-video-time-text {
    color: #fff;
    line-height: 40px;
    font-size: 14px;
  }
  .cl-contrl-video-time-total {
    line-height: 40px;
    font-size: 14px;
    color: #999;
  }
